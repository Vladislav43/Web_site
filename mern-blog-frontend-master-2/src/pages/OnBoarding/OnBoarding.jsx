...
const OnBoarding = () => {
    ...
    return (
        <div className={styles.onboarding}>
            <h2>CREATE ANKETA</h2>
            <div className={styles.formContainer} style={{ maxHeight: '600px', overflowY: 'auto' }}>
                    ...
                    <section className={styles.wrapper}>
                        <div className={styles.form}>
                            ...
                            <input
                                ...
                                type="text"
                                name="telegramUrl"
                                placeholder="Введіть посилання на Telegram"
                            ...
                            <input
                                ...
                                type="text"
                                name="instagramUrl"
                                placeholder="Введіть посилання на Instagram"
